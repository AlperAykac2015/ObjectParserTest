...
public class App {
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("car brand = " + cars.getCars()[0].getInsurances()[0]);	
			System.out.println("car brand = " + cars.getCars()[0].getInsurances()[1]);	
			System.out.println("car brand = " + cars.getCars()[0].getInsurances()[2]);	
